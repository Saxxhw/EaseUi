package com.hyphenate.easeui.init;
...
import com.hyphenate.easeui.init.db.DemoDBManager;
import com.hyphenate.easeui.init.db.InviteMessgeDao;
import com.hyphenate.easeui.init.db.UserDao;
import com.hyphenate.easeui.init.domain.InviteMessage;
import com.hyphenate.easeui.init.domain.RobotUser;
import com.hyphenate.easeui.init.parse.UserProfileManager;
...
public class EaseInitHelper {
    ...
    private static final String TAG = "EaseInitHelper";
    ...
    private static EaseInitHelper instance = null;
    ...
    public synchronized static EaseInitHelper getInstance() {
        if (instance == null) {
            instance = new EaseInitHelper();
        }
        return instance;
    }
     ...
     */
    public void init(Context context, Class<?> mainActivity, Class<?> chatActivity) {
        this.mainActivityClass = mainActivity;
        this.chatActivityClass = chatActivity;
    ...
    private class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationAccepted(String groupId, String invitee, String reason) {
            ...
            msg.setTime(System.currentTimeMillis());
            msg.setGroupId(groupId);
            msg.setGroupName(_group.getGroupName());
            msg.setReason(reason);
            msg.setGroupInviter(invitee);
            showToast(_group.getGroupName());
    ...
    private class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = EaseInitHelper.getInstance().getContactList();
    ...
    private void onUserException(String exception) {
        ...
        Intent intent = new Intent(appContext, mainActivityClass);
     ...
     * update contact list
     */
    private void setContactList(Map<String, EaseUser> aContactList) {
    ...
    private void setRobotList(Map<String, RobotUser> robotList) {
        this.robotList = robotList;
    }

    private Map<String, RobotUser> getRobotList() {
     ...
     */
    private synchronized void asyncFetchGroupsFromServer(final EMCallBack callback) {
    ...
    private void noitifyGroupSyncListeners(boolean success) {
