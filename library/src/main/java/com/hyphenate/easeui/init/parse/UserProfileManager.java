package com.hyphenate.easeui.init.parse;
...
import com.hyphenate.easeui.init.PreferenceManager;
...
public class UserProfileManager {
     ...
     */
    private List<EaseInitHelper.DataSyncListener> syncContactInfosListeners;
    ...
    public void addSyncContactInfoListener(EaseInitHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
    ...
    public void removeSyncContactInfoListener(EaseInitHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
        if (syncContactInfosListeners.contains(listener)) {
    ...
    public void asyncFetchContactInfosFromServer(List<String> usernames, final EMValueCallBack<List<EaseUser>> callback) {
        ...
        ParseManager.getInstance().getContactInfos(usernames, new EMValueCallBack<List<EaseUser>>() {
            ...
            public void onSuccess(List<EaseUser> value) {
                ...
                // return immediately
                if (!EaseInitHelper.getInstance().isLoggedIn()) {
                    return;
                }
                if (callback != null) {
    ...
    public void notifyContactInfosSyncListener(boolean success) {
        for (EaseInitHelper.DataSyncListener listener : syncContactInfosListeners) {
    ...
    public void setUserNickAndAvatar(String nick, String avatar) {
        setCurrentUserNick(nick);
