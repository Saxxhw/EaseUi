...
public class RecorderVideoActivity extends EaseBaseActivity implements OnClickListener, SurfaceHolder.Callback, OnErrorListener, OnInfoListener {
            ...
            msc = new MediaScannerConnection(this,
                    new MediaScannerConnectionClient() {
                        ...
                        public void onScanCompleted(String path, Uri uri) {
                            ...
                            setResult(RESULT_OK, getIntent().putExtra(VIDEO_URI, uri));
                            finish();
                        }
