...
public class EaseChatRowImage extends EaseChatRowFile {
    ...
    private void showImageView(String thumbernailPath, String localFullSizePath, EMMessage message) {
        ...
        if (bitmap != null) {
            ...
            imageView.setImageResource(R.drawable.ease_default_image);
            new Task(thumbernailPath, localFullSizePath, message).execute();
        }
    }
    ...
    class Task extends AsyncTask<Object, Void, Bitmap> {
        ...
        String thumbernailPath;
        String localFullSizePath;
        EMMessage message;

        Task(String thumbernailPath, String localFullSizePath, EMMessage message) {
